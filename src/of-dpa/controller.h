...
public:
  ...
  int l3_unicast_host_add(const rofl::caddress_in4 &ipv4_dst,
                          ...
                          bool update_route, uint16_t vrf_id = 0) noexcept override;
  int l3_unicast_host_remove(
      const rofl::caddress_in4 &ipv4_dst, uint16_t vrf_id = 0) noexcept override;

  int l3_unicast_host_add(const rofl::caddress_in6 &ipv6_dst,
                          uint32_t l3_interface, bool is_ecmp,
                          bool update_route, uint16_t vrf_id = 0) noexcept override;
  int l3_unicast_host_remove(
      const rofl::caddress_in6 &ipv6_dst, uint16_t vrf_id = 0) noexcept override;
  ...
  int l3_unicast_route_remove(const rofl::caddress_in4 &ipv4_dst,
                              const rofl::caddress_in4 &mask, uint16_t vrf_id = 0) noexcept override;
  ...
  int l3_unicast_route_remove(const rofl::caddress_in6 &ipv6_dst,
                              const rofl::caddress_in6 &mask, uint16_t vrf_id = 0) noexcept override;
